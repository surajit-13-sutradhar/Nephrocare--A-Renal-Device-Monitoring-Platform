...
const PasswordSetting = () => {
    ...
    // Function to submit the password. modify this to store password in the database in the production
    // const onSubmit = (e) => {
    //     e.preventDefault();
    ...
    return (
        ...
        >
            ...
            />
            <Button color="primary" type="submit" className="mx-auto mt-4 w-full" onClick={() => {}}>
                Finish Sign-Up
            </Button>
            {submitted && (
